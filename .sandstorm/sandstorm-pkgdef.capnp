...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "xtn0a4zv85vuvfcawysxkh3qagmf4nc6v3x4ejx5fntqm44mk9n0",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Iroh Tunnel"),
    ...
    metadata = (
      ...
      codeUrl = "https://github.com/example/iroh-tunnel",
      ...
      author = (
        ...
        upstreamAuthor = "Iroh Tunnel Team",
      ...
      shortDescription = (defaultText = "Capability tunnel"),
      # A very short (one-to-three words) description of what the app does. For example,
      # "Document editor", or "Notetaking", or "Email client". This will be displayed under the app
      # title in the grid view in the app market.

      description = (defaultText = "Experimental Sandstorm app that pairs two grains over iroh and relays selected Cap'n Proto capabilities between them."),
